...
extends o {
    public at(IBaritone iBaritone, BetterBlockPos betterBlockPos, BetterBlockPos betterBlockPos2) {
        super(iBaritone, betterBlockPos, betterBlockPos2);
    }

    @Override
    public final double a(CalculationContext calculationContext) {
        return at.a(calculationContext, this.a.a, this.a.c, this.a.d);
    }
    ...
    public static double a(CalculationContext calculationContext, int n, int n2, int n3) {
        alz alz2 = calculationContext.a(n, n2 - 1, n3);
        if (!p.a(calculationContext, n, n2 - 1, n3, alz2) && !p.b(alz2.c())) {
            return 1000000.0;
        }
        if (!p.a(calculationContext, n, n2 - 2, n3)) {
